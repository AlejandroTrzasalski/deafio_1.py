def mostrar_menu():
    ...
    9 - Determinar cual es el maximo de poder y mostrar los nombres de cuales
        heroes tienen un poder inferior A LA MITAD DE PODER del heroe mas fuerte.
    10 - Ordenar los heroes por porder ascendente y mostrarlos.
